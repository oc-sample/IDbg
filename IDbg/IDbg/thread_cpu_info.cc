...
float GetSysCpu() {
    ...
    return 100.0*((float)(cpuinfo.cpu_user + cpuinfo.cpu_system) /
                  (float)(cpuinfo.cpu_user + cpuinfo.cpu_system
...
int GetThreadInfoById(ThreadStackArray& ls,
                      const ThreadIdArray& id_ls,
